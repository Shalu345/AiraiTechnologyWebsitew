...
//   return (
//     <section className="bg-black pb-[150px] font-cabin  pt-[0px] px-[150px] relative">
//       {/* Heading + Description */}
...
//         </h2>
//         <p className="text-white  max-w-4xl opacity-90 mt-[6px] font-cabin mx-auto text-[16px]">
...
// <div className="w-[978px] mt-[32px] mx-auto space-y-5 font-cabin">
//   {faqs.map((faq, index) => {
//     const isOpen = openIndex === index;
//     return (
//       <div
...
//   {/* Bottom-right blur */}
//   <span
//     className="absolute top-[px] right-[-150px] w-[450px] h-[440px] pointer-events-none rounded-none"
//     style={{
   
//       background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
//       filter: "blur(190px)",
//       opacity: 0.8,
//       transform: "translate(55%, -196%)",
//     }}
//   ></span>
...
export default function FAQQuestion() {
  ...
  return (
    <section className="sm:pt-[0px]  bg-black sm:overflow-x-hidden">
   
       <ReuseFAQSection/>
  <span
    className="absolute sm:hidden top-[px] right-[-150px]  w-[450px] h-[440px] pointer-events-none rounded-none"
    style={{
