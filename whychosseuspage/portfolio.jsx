...
//     image: "/Frame 30 (3).png", 
//     title: "E-Commerce Solutions", 
//     desc: "We develop feature-rich e-commerce platforms that are secure, fast, and scalable. Our solutions focus on providing seamless shopping experiences while integrating modern tools for payments, inventory, and analytics." 
//   },
//   { 
//     image: "/Frame 30.png", 
//     title: "Logo Design", 
//     desc: "Our creative team designs intuitive interfaces that blend aesthetics with usability. We focus on smooth navigation, user-friendly layouts, and engaging experiences that connect with your audience." 
//   },
// ];
...
export default function Portfolio() {
  ...
  return (
    <section className="relative  sm:pt-[0px]  sm:pb-[80x]  bg-black sm:px-1  sm:overflow-x-hidden">
  ...
  <ReuseOurPortfolio/>
      ...
      <span
    className="absolute sm:hidden w-[450px] h-[440px] pointer-events-none rounded-none"
    style={{
      // background: "radial-gradient(circle, #FF9F0D 0%, #FF4E3D 50%, #ED09EE, #1091F8,  transparent 90%)",
      //  background: "radial-gradient(circle, #FF9F0D 0%, #FF4E3D 20%, #ED09EE 50%, #ED09EE 70%, #1091F8 90%, transparent 100%)",
     background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
  ...
  <span
    className="absolute sm:hidden w-[200px] h-[450px] 3xl:h-[200px] rounded-none pointer-events-none"
    style={{
      // background: "radial-gradient(circle, #FF9F0D 0%, #FF4E3D 50%, #ED09EE, #1091F8,  transparent 90%)",
      background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
      filter: "blur(157px)",
      opacity: 0.8,
      transform: "translate(755%, -138%)",
   ...(typeof window !== "undefined" && window.innerWidth >= 1920
      ? { filter: "blur(100px)", left: "1050px", bottom: "-2005px", position: "absolute" }
      : {}),
    }}
  ></span>
