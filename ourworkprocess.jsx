...
//   return (
//     <section className="bg-black  px-[150px] pb-[150px] relative ">
//       {/* Upper Section */}
...
//         {/* Left Image */}
//         <div className="h-[560px] object-contain bg-cover bg-yellow-00 leading-none">
//           <img
//             src="image.png" 
//             alt="Work Process Illustration"
//             className=" h-[570px] rounded-2xl object-contain -mt-5"
...
export default function OurWorkProcess() {
  ...
  return (
    <section className="bg-black sm:pt-[80px]   relative " >
    <ReuseOurWorkProcess/>
  <span
    className="absolute sm:hidden w-[240px] h-[340px] 3xl:left-[100px] pointer-events-none rounded-none"
    style={{
      // background: "radial-gradient(circle, #FF9F0D 0%, #FF4E3D 50%, #ED09EE, #1091F8,  transparent 90%)",
       background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
      filter: "blur(150px)",
        ...(typeof window !== "undefined" && window.innerWidth >= 1920 ? { filter: "blur(240px)", left: "40px" } : {}),
      opacity: 0.8,
      transform: "translate(-95%, -355%)",
    }}
  ></span>
    ...
    <span
    className="absolute left sm:hidden  w-[200px] h-[450px] rounded-none pointer-events-none"
    style={{
      // background: "radial-gradient(circle, #FF9F0D 0%, #FF4E3D 50%, #ED09EE, #1091F8,  transparent 90%)",
            // background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
              //  background: "radial-gradient(circle,rgba(255, 159, 13, 1),rgba(255, 78, 61, 1) , rgba(237, 9, 238, 1),rgba(16, 145, 248, 1))",
